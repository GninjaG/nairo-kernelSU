...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/home/vitorromromrom/crdroid/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- --gcc-toolchain=/home/vitorromromrom/crdroid/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9 -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
